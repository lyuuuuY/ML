...
hidden_bias = weights[[1]][2,]
output_weights = weights[[2]][1:10]
output_bias = weights[[2]][length(weights[[2]])]

x = 10
hidden_output = x * hidden_weights + hidden_bias
activate_output = pmax(0, hidden_weights)

output = t(output_weights) %*% activate_output + output_bias
```
